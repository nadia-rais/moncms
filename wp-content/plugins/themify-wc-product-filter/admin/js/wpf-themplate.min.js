'use strict';var WPF;
(function(b,l,h,m){WPF={prefix:"wpf_",template_type:!1,init:function(a){a=b.extend({prefix:this.prefix,template_type:this.template_type},a);this.prefix=a.prefix;this.template_type=a.template_type;this.Undelegate();this.bindEvents()},Undelegate:function(){b(h).off("change click")},bindEvents:function(){this.SetupColors();this.InitDraggable();this.InitSortable();this.ShowHide();this.Unique(b("#"+this.prefix+"module_content ."+this.prefix+"back_active_module_content"));this.Open();this.Delete();this.Save();
...
a.slideDown()})},RemmoveItem:function(){b("#"+WPF.prefix+"module_content").delegate("."+WPF.prefix+"remove_item","click",function(a){a.preventDefault();b(this).closest("li").slideUp(function(){b(this).remove()})})},multiLanguages:function(){b("body").on("click",".wpf_language_tabs li",function(a){a.preventDefault();a=b(this);if(!a.hasClass("wpf_active_tab_lng")){a.siblings(".wpf_active_tab_lng").removeClass("wpf_active_tab_lng");a.addClass("wpf_active_tab_lng");var c=a.parents(".wpf_language_tabs").parent().find(".wpf_language_fields");
c.find("li").removeClass("wpf_active_lng");c.find('li[data-lng="'+a.children("a").attr("class")+'"]').addClass("wpf_active_lng")}})}}})(jQuery,window,document);
