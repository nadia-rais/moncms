...
<?php
global $post_type;
$message =  __('Import will overwrite all existed templates. Press OK to continue, Cancel to stop.', 'wpf') ;
$extensions = array(
    array(
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        wpf_import(jQuery('#<?php echo $this->plugin_name ?>-import-btn'),<?php echo wp_json_encode($plupload_init);?>);
    });
</script>
